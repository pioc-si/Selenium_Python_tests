...
class ProductPage(BasePage):
    ...
    def should_be_correct_name_product(self):
        ...
        assert product_name == product_name_in_message, \
            f'Product name in message is not correct product name'
    ...
    def should_be_correct_price_product_in_message_and_price_product(self):
        ...
        assert product_price == product_price_in_message, \
            f'Product price in message is not correct product price'
